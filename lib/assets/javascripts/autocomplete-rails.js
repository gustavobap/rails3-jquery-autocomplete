      ...
      jQuery(e).autocomplete({
        source: function( request, response ) {
          jQuery.getJSON( jQuery(e).attr('data-autocomplete'), {
            ...
            search_extra_params: jQuery(e).attr('search-extra-params')
          }, function() {
        ...
        change: function( event, ui ) {
            if(!ui.item || jQuery(jQuery(this).attr('data-id-element')).val() == ""){
                jQuery(this).val("");
                $(e).trigger('railsAutocomplete.deselect', ui);
            }else{
                jQuery(this).val(e.selectedString);
            }
        ...
        search: function() {
          ...
          minLength = jQuery(e).attr('min-length');
          if(minLength == null){
            minLength = 2;
          }
